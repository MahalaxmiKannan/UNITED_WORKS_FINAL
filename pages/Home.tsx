...
const HeroSection = () => (
  <div className="p-4 sm:p-6">
    <div className="relative h-[400px] sm:h-[500px] md:h-[550px] lg:h-[600px] rounded-2xl overflow-hidden">
      {/* Background video */}
      <video
        autoPlay
        loop
      ...
      {/* Foreground content */}
      <div className="relative z-10 flex flex-col items-start justify-start h-full text-white p-4 sm:p-6 md:p-8 lg:p-12">
...
const StatsSection = () => (
  <div className="py-12 sm:py-16 lg:py-20 bg-uw-orange bg-opacity-10" style={{ backgroundImage: '../assets/images/globe-icon.png' }}>
