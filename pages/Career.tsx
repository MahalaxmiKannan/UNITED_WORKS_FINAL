...
const CareerHeroImg = "/Safety_Briefing_1.jpeg";
  ...
  >
    ...
    <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4 sm:px-6">
      ...
      <p className="mt-4 sm:mt-6 max-w-2xl text-sm sm:text-base lg:text-lg text-gray-200">
        Join our team of dedicated professionals and be part of Singapore's
        infrastructure development. We offer exciting career opportunities in
        civil engineering, project management, and technical services.
      </p>
    </div>
  </div>
);
  ...
  >
    <div className="container mx-auto px-4 sm:px-6 text-center">
      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 text-uw-dark">
        Why Join United Works?
      </h2>
      <p className="max-w-3xl mx-auto text-uw-grey-1 leading-relaxed text-sm sm:text-base mb-8 sm:mb-12">
        At United Works, we believe our people are our greatest asset. We foster
        a culture of collaboration, innovation, and integrity where every team
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        {BENEFITS_DATA.map((benefit, index) => (
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-3 text-uw-dark">
              {benefit.title}
            </h3>
            <p className="text-sm sm:text-base text-uw-grey-1 leading-relaxed">
              {benefit.description}
            </p>
          </div>
        ))}
      ...
      <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        <div className="order-2 lg:order-1">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-lg text-uw-dark mb-2">
                  Safety First
                </h3>
                <p className="text-uw-grey-1 text-sm sm:text-base">
                  We prioritize the safety and wellbeing of our team members
                  above all else, maintaining the highest safety standards
                  across all projects.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-uw-grey-1 text-sm sm:text-base">
                  ...
                  where diverse perspectives are valued and respected.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-uw-grey-1 text-sm sm:text-base">
                  We embrace new technologies and innovative solutions to
                  deliver better outcomes for our clients and communities.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
        ...
        <div className="order-1 lg:order-2">
          <div className="bg-uw-grey-2 rounded-lg p-6 sm:p-8">
            <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-uw-dark">
              Company at a Glance
            </h3>
            <div className="grid grid-cols-2 gap-4 sm:gap-6">
              {COMPANY_STATS.map((stat, index) => (
                <div key={index} className="text-center">
                  ...
                  <p className="text-lg sm:text-xl font-bold text-uw-dark">
                    {stat.value}
                  </p>
    ...
    <div className="p-4 sm:p-6">
      <div className="flex justify-between items-start">
        <div className="flex-1">
          <h3 className="text-lg sm:text-xl font-bold text-uw-dark mb-2">
            {job.title}
          </h3>
          ...
          <p className="text-sm sm:text-base text-uw-grey-1 mb-4">
            {job.description}
          </p>
        </div>
        <button
            ...
            <div>
              ...
              <ul className="space-y-2">
                {job.requirements.map((req, index) => (
                  <li
                    key={index}
                    className="flex items-start space-x-2 text-sm text-uw-grey-1"
                  >
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="max-w-2xl mx-auto text-uw-grey-1 text-sm sm:text-base">
            Explore exciting career opportunities with United Works. We're
  ...
  <div className="py-12 sm:py-16 lg:py-24 bg-white">
    <div className="container mx-auto px-4 sm:px-6">
      <div className="text-center mb-8 sm:mb-12">
        ...
        <p className="max-w-2xl mx-auto text-uw-grey-1 text-sm sm:text-base">
          Hear from our team members about their experiences working at United
          Works.
        </p>
      </div>
          ...
          <div key={index} className="bg-uw-grey-2 rounded-lg p-6 sm:p-8">
            <div className="flex items-start space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-uw-orange font-semibold text-sm">
                  {testimonial.position}
                </p>
                <p className="text-uw-grey-1 text-sm">
                  {testimonial.department} • {testimonial.yearsAtCompany}
                </p>
              </div>
            </div>
  ...
  <div className="py-12 sm:py-16 lg:py-24 bg-uw-orange bg-opacity-10">
    <div className="container mx-auto px-4 sm:px-6">
      <div className="text-center mb-8 sm:mb-12">
        ...
        <p className="max-w-2xl mx-auto text-uw-grey-1 text-sm sm:text-base">
          We've streamlined our hiring process to make it as smooth and
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
        ...
        <div className="text-center">
          ...
          <h3 className="font-bold text-lg text-uw-dark mb-2">
            Initial Review
          </h3>
          <p className="text-uw-grey-1 text-sm sm:text-base">
            Our HR team reviews your application within 3-5 business days.
          </p>
        </div>
        <div className="text-center">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-uw-orange rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-uw-grey-1 text-sm sm:text-base">
            Meet with our team for technical and cultural fit interviews.
          </p>
        </div>
        <div className="text-center">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-uw-orange rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-uw-grey-1 text-sm sm:text-base">
            Join our team and start your journey with United Works!
          </p>
        </div>
      </div>
    </div>
