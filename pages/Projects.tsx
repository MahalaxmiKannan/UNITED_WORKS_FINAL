...
const MilestonesSection = () => {
  ...
  const milestoneData = MILESTONES_TIMELINE.map((milestone, index) => {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative py-12 sm:py-16 lg:py-24 bg-uw-dark"
    >
      <div
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23E97522' fill-opacity='0.5'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")",
        }}
      >
        <h2
          className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-8 text-white"
          style={{ color: "#E97522" }}
        >
          ...
          {milestoneData.map((m, index) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className={`absolute font-bold text-xl lg:text-2xl text-white left-1/2 -translate-x-1/2 ${
                    m.isUpper ? "top-8" : "bottom-8"
                  }`}
                >
                  {m.year}
                </p>
              ...
              <div className="flex-1">
                ...
                <div className="mt-2">
                  <img
                    src={m.imageUrl}
                    alt={`Milestone ${m.year}`}
                    className="rounded-lg w-full max-w-xs object-cover aspect-[4/3]"
                  />
                </div>
              </div>
            </div>
...
const Projects = () => {
  ...
  const madeByImages: { src: string; label: string; caption: string }[] = [
    ...
    {
      src: "/assets/images/IMG-20250906-WA0094.jpg",
      label: "Equipment Setup",
      caption: "Mobilisation and heavy equipment setup",
    },
    {
      src: "/assets/images/IMG-20250906-WA0102.jpg",
      label: "Reinstatement",
    ...
    {
      src: "/assets/images/IMG-20250906-WA0096.jpg",
